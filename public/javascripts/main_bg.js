...
Boid.prototype.render = function() {
    ...
    rotate(theta);
    textSize(64);
   // text(textPool[ Math.floor(Math.random() * 12)],50,50);
...
Boid.prototype.cohesion = function(boids) {
    ...
    var count = 0;
    for (var i = 0; i < boids.length; i++) {
        var d = p5.Vector.dist(this.position,boids[i].position);//seems that's where it's going
        if ((d > 0) && (d < neighbordist)) {
